    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(childText.getText() == "FLY PAPER"){
                    Intent intent = new Intent(context, Detail2.class);
                    intent.putExtra("booktype", 01);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                }
                else if(childText.getText() == "Avengers"){
                    Intent intent = new Intent(context, Detail2.class);
                    intent.putExtra("booktype", 03);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                }
                else if(childText.getText() == "Mission Impossible"){
                    Intent intent = new Intent(context, Detail2.class);
                    intent.putExtra("booktype", 02);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                }
                else if(childText.getText() == "Spiderman4"){
                    Intent intent = new Intent(context, Detail2.class);
